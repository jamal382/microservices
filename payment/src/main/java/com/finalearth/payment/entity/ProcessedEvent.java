 ...
 * rebalance, for any record that was in flight. Here that means a redelivered
 * {@code stock.reserved} is an attempt to charge the same card twice for the same order,
 * which is the single worst outcome available to this system.
 *
