 ...
 * rebalance, for any record that was in flight. Without a guard, a redelivered
 * {@code payment.failed} would emit a second {@code order.cancelled}, and
 * {@code inventory} would release the same units twice.
 *
